...
echo .
echo  %date% %time% calling loadPR19baseapp1.bat ...
...
echo  %date% %time% running ... python.exe .\outcomesDataProc.py PR19baseapp1 --user %UPDATE_AUTHORISED_BY%  --comment "Initial load" --input_file "..\resources\Pauls_latest_PR19.xlsx"
python.exe .\outcomesDataProc.py PR19baseapp1 --user %UPDATE_AUTHORISED_BY%  --comment "Initial load" --input_file "..\resources\Pauls_latest_PR19.xlsx"
...
echo  %date% %time% completed loadPR19baseapp1.bat
