...
echo .
echo  %date% %time% running loadPR14submeasures.bat ...
...
echo  %date% %time% running ... python.exe .\outcomesDataProc.py PR14basesubmeasures --user %UPDATE_AUTHORISED_BY%  --comment "Initial load" --input_file "..\resources\AnnesPR14.xlsx"
python.exe .\outcomesDataProc.py PR14basesubmeasures --user %UPDATE_AUTHORISED_BY%  --comment "Initial load" --input_file "..\resources\AnnesPR14.xlsx"
...
echo  %date% %time% completed loadPR14submeasures.bat
