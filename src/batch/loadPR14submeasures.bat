...
echo  %date% %time% running ... python.exe .\outcomesDataProc.py PR14submeasures --user %UPDATE_AUTHORISED_BY%  --comment "Initial load" --input_file "..\resources\AnnesPR14.xlsx"
python.exe .\outcomesDataProc.py PR14submeasures --user %UPDATE_AUTHORISED_BY%  --comment "Initial load" --input_file "..\resources\AnnesPR14.xlsx"
