...
def upload_data():
    ...
    cursor.execute("SELECT * FROM " + schemaNameUsed + ".PR14FinalCSVcreatedbyPython")
    ...
    cursor.execute("SELECT * FROM " + schemaNameUsed + ".PR19FinalCSVcreatedbyPython")
    queryForSubmeasureTableCheck = cursor.fetchone()
    if queryForSubmeasureTableCheck == None:
        cursor.execute(
    ...
    # cursor.execute("SELECT * FROM " + schemaNameUsed + ".PR14SubmeasureFinalCSVcreatedbyPython")
    # queryForSubmeasureTableCheck = cursor.fetchone()
    # if queryForSubmeasureTableCheck == None:
    cursor.execute(
